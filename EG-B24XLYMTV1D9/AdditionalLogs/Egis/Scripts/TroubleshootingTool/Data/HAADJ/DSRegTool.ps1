...
Write-Host ''
Write-Host "Enter (1) to troubleshoot Azure AD Join device" -ForegroundColor Green
Write-Host ''
Write-Host "Enter (2) to troubleshoot Hybrid Azure AD Join" -ForegroundColor Green
Write-Host ''
Write-Host "Enter (3) to verify Service Connection Point (SCP)" -ForegroundColor Green
Write-Host ''
Write-Host "Enter (4) to verify the health status of the device" -ForegroundColor Green
Write-Host ''
#Write-Host "Enter (6) to Verify Primary Refresh Token (PRT)" -ForegroundColor Green
#Write-Host ''
Write-Host "Enter (5) to collect the logs" -ForegroundColor Green
Write-Host ''
